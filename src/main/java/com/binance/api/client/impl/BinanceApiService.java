...
import com.binance.api.client.domain.account.request.DustResponse;
...
public interface BinanceApiService {
    ...
    Call<DustResponse> cleanDust(@Query("asset") ArrayList<String> asset, @Query("recvWindow") Long window, @Query("timestamp") Long timestamp);
